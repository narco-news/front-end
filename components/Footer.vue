<template>
  <div style="background-color: #1b2431;" class="pt-3">
      ...
      <div class="grid grid-cols-2 md:grid-cols-5 gap-4 text-white">
        <div class="col-span-3 p-2">
          ...
          <div class="w-full grid grid-cols-2 lg:grid-cols-3 text-xs">
            ...
            <n-link class="p-1" to="/tag/central-america">Central America</n-link>
            ...
            <n-link class="p-1" to="/tag/film-and-television">Film and Television</n-link>
        ...
        <div class="col-span-1 p-2">
          ...
          <div class="flex flex-col text-xs">
            ...
            <a class="p-1" href="https://github.com/narco-news/front-end">Github</a>
        ...
        <div class="col-span-1 p-2">
          ...
          <div class="flex flex-col text-xs">
            <a class="p-1" target="_blank" href="https://smallwarsjournal.com/elcentro">El Centro</a>
            <a class="p-1" target="_blank" href="http://www.borderlandbeat.com/">Borderland Beat</a>
            <a class="p-1" target="_blank" href="https://www.insightcrime.org/">InSight Crime</a>
            <a
              class="p-1"
              target="_blank"
    ...
    <div></div>
    <div class="bottom-0 pb-1 text-center">
