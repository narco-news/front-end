		...
		<div class="bg-white rounded mx-2">
			<div>
				...
				<div class="p-4">
					...
					<div class="pattern-dots-sm h-2 my-2"></div>
					<!-- MEXICO BEGIN CONTENT -->
					<div class="mx-2">
						...
						<div>
							...
							<paper
								...
								downLink="https://sci-hub.tw/10.1080/1057610X.2019.1586356"
					...
					<div class="mx-2">
						...
						<div>
							<paper
								title="The Strategic Implications of the Cártel de Jalisco Nueva Generación"
								infoLink="https://www.jstor.org/stable/26466904?seq=1#metadata_info_tab_contents"
								downLink="https://sci-hub.st/https://www.jstor.org/stable/26466904?seq=1#metadata_info_tab_contents"
								authors="Nathan P. Jones"
								date="2018"
								abstract="Most security analysts now view the Cártel de Jalisco Nueva Generación (CJNG) as the most powerful organized crime group (OCG) in Mexico. This article explores the strategic/security implications of the rise of this new and aggressive group by providing an in-depth historical case study. The case study shows that the CJNG is a highly resilient and geographically dispersed entity that draws upon the experience of its members, which studied under the tutelage of the Milenio and Sinaloa cartels. Since 2015 the CJNG has begun “adopting orphan” criminal cells left in the wake of the US and Mexican kingpin strategy and the resulting OCG fragmentations. This demonstrates the limits of kinetic strategies in the drug war as the Mexican drug trafficking system appears to be reconsolidating under the CJNG. Policy reform areas such as legal reform implementation, penal system capacity building, and tax reform goals are discussed."
							></paper>
							<paper
								title="The New Generation: Mexico’s Emerging Organized Crime Threat"
								infoLink="https://justiceinmexico.org/wp-content/uploads/2018/03/180319-Policy_Brief-CJNG.pdf"
								downLink="https://justiceinmexico.org/wp-content/uploads/2018/03/180319-Policy_Brief-CJNG.pdf"
								authors="Lucy La Rosa, David A. Shirk"
								date="2018"
								abstract="Over the past decade, more than 200,000 people have been murdered in Mexico, including the record 29,000 murders that occurred in 2017 alone. While there are complex underlying factors behind every individual homicide, a substantial portion of Mexico’s recent violence is attributable to organized crime groups. In an effort to reduce the operational capabilities of these groups, the government of Mexico has responded to this crisis with a deliberate strategy to target top organized crime figures for arrest and even extradition. In January 2017, these efforts culminated in the downfall of famed drug trafficker, Joaquín “El Chapo” Guzmán, who was extradited to the United States and is currently preparing to stand trial for various related crimes in New York."
							>
							</paper>
						</div>
					</div>
					...
					<div class="mx-2">
						...
						<div>
							<paper
								...
								infoLink="https://www.tandfonline.com/doi/abs/10.1080/09592318.2011.620813"
								downLink="https://sci-hub.tw/10.1080/09592318.2011.620813"
...
export default {
	...
	data() {
		return {
			paperTitle: 'Drug Cartels in the United States',
			paperUrl: '#'
		};
	}
};
