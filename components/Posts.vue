			...
			<div class="row">
				<div class="md-11 lg-10 mx-auto">
					<div class="post-content">
						...
						<div class="excerpt text-lg md:text-xl">
						...
						<div class="post-meta">
							<ul class="list meta">
								...
								>
									...
									<span
										style="color: #ffd600; letter-spacing: 1.4px;"
						...
						<div class="flex justify-end">
							<div class="grid grid-cols-1">
								<div
									class="flex justify-end m-2 text-gray-500 text-xs uppercase"
								>
									share
								</div>
								<div>
									<div class="hvr-float-shadow mx-2">
										<a
											:href="
