			...
			<div class="row">
				<div class="md-11 lg-10 mx-auto">
					<div class="post-content">
						...
						<h1 v-if="post.title" class="post-title">
								...
								<dropdown-content>
									...
									<dropdown-item
										:url="
											...
											post.slug
										"
										click="window.open(this.href,'twitter-share','width=550,height=235');return false;"
										link-class="twitter"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
									...
									<dropdown-item
										:url="
											...
											post.slug
										"
										click="window.open(this.href,'facebook-share','width=580,height=296');return false;"
										link-class="facebook"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
