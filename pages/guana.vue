<template>
	<div id="map" class="sm:mt-8 sm:mx-5 sm:mb-5 rounded-md shadow-md"></div>
</template>

<script>
import depots from 'assets/depots.json';
export default {
	name: 'DepotsMap',
	data() {
		return {
	...
	mounted() {
		...
		const bounds = [
			[-101.931481, 20.179955], // Southwest coordinates
			[-100.035476, 21.858407] // Northeast coordinates
		];
